...
CSRF_TRUSTED_ORIGINS = ["http://localhost","http://127.0.0.1","http://pbp.cs.ui.ac.id/ferdinand.bonfilio/mentalhealthtracker", "https://pbp.cs.ui.ac.id/ferdinand.bonfilio/mentalhealthtracker"]
